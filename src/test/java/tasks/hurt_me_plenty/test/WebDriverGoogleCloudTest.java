...
package tasks.hurt_me_plenty.test;
...
import tasks.hurt_me_plenty.dataEntity.InstancesData;
import tasks.hurt_me_plenty.formatter.ValueFormatter;
import tasks.hurt_me_plenty.page.GoogleCloudHomePage;
...
public class WebDriverGoogleCloudTest {
    ...
    public Object[][] testData() {
        return new Object[][]{
                new Object[]{new InstancesData("4", "",
                        ...
                        "e2-standard-8 (vCPUs: 8, RAM: 32GB)", "4", "NVIDIA Tesla V100", "24x375 GB",
    ...
    public void checkTotalEstimateCost(InstancesData testInstancesData) {
        final String TOTAL_ESTIMATE_COST_BY_MANUAL_TEST = "USD 635.29 per 1 month";
