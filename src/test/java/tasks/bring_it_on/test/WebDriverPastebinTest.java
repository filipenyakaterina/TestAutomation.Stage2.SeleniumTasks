...
package tasks.bring_it_on.test;
...
import tasks.bring_it_on.page.PasteCreatingResultPage.FontCssStyle;
import tasks.bring_it_on.page.PastebinHomePage;
    ...
    public Object[][] testData() {
        return new Object[][]{
                new Object[]{new Paste("git config --global user.name  \"New Sheriff in Town\"\n" +
                        "git reset $(git commit-tree HEAD^{tree} -m \"Legacy code\")\n" +
                        "git push origin master --force", "8", "10M",
